...
const conditions: Condition[] = [
  {
    ...
    features: [
      ...
      { feature: 'Body heatmap', benefit: 'ADHD overwhelm lives in the body before you notice it mentally. The heatmap visualizes where you feel tension and stress — building awareness of physical patterns over time.' },
  ...
  },
  {
    ...
    features: [
      { feature: 'AI emotion detection from speech', benefit: 'Speak freely about your day — the AI identifies emotions from your words and context without you needing to label them.' },
      { feature: 'Body heatmap builds your emotion dictionary', benefit: 'As you journal, the heatmap reveals connections: "chest tightness often appears with what the AI calls apprehension." Your body becomes a map to emotions you couldn\'t name before.' },
      { feature: 'Self-correction trains a personal translator', benefit: 'Each correction teaches the AI your unique emotional dialect. Over time, it adapts to YOUR language — not a textbook\'s. The more you correct, the more fluent it becomes.' },
      { feature: 'Body region tap-map (8 zones)', benefit: 'Can\'t name the feeling? Tap where you feel it — head, chest, stomach, hands, and more. The app connects your physical experience to emotional patterns over time.' },
      ...
      { feature: 'Gradual emotional literacy', benefit: 'Eight core emotions from Plutchik\'s wheel give you a starting vocabulary. Over time, corrections and reflections expand your personal emotion language — at your own pace, never forced.' },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { feature: 'Predictable, structured flow', benefit: 'Multi-step reflection follows a clear sequence: emotions, sliders, body scan. Same order every time. No surprises.' },
      ...
      { feature: '50-second low-barrier entry', benefit: 'Processing doesn\'t need to be a project. Speak for under a minute and get a full emotional snapshot — minimal energy expenditure for maximum insight.' },
      { feature: 'Valence-arousal over emotion labels', benefit: 'Don\'t relate to standard emotion names? Simply indicate pleasant/unpleasant and calm/activated on sliders. The system works without forcing neurotypical vocabulary.' },
    ],
