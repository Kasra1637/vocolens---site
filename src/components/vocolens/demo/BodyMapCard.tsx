    ...
    >
      ...
      <div className="flex justify-center mb-2.5">
        <svg
          ...
          viewBox="0 0 160 320"
          role="img"
          aria-label="Body sensation heatmap"
        >
          ...
          {(Object.keys(HEAT_OF) as BodyRegion[]).map((region) => (
            <g key={region} onClick={() => toggle(region)} style={{ cursor: "pointer" }}>
      ...
      {selected && selectedStat && (
        <div
          ...
          style={{
            ...
            border: `1px solid ${heatStroke(selectedStat.heat)}`,
          }}
        >
      ...
      <div className="flex flex-col gap-0.5">
        {STATS.map(({ region, count, heat }) => (
          ...
          >
            <span className="text-[10px] w-4 text-center" aria-hidden="true">
              {EMOJIS[region]}
            </span>
            <span
            ...
            >
              <span
                ...
                style={{ width: `${heat * 100}%`, background: heatFill(heat) }}
              />
            </span>
            <span
              className="text-[8px] font-semibold w-5 text-right tabular-nums"
