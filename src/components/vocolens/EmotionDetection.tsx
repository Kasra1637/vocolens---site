    ...
    <section className="max-w-7xl mx-auto px-6 py-16 lg:py-24 overflow-hidden">
      ...
      <AnimatedSection animation="fade-in-up" delay={0.1} className="mb-16 lg:mb-20">
        <div className="relative">
          <div className="hidden md:flex items-center justify-center gap-1.5 mb-8" aria-hidden="true">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="card-app rounded-3xl p-5 flex flex-col">
              <div className="w-14 h-14 rounded-full chip-app text-[#6A3FC0] flex items-center justify-center mb-5">
      ...
      <AnimatedSection animation="fade-in-up" delay={0.2}>
        <div className="grid lg:grid-cols-5 gap-8 items-stretch">
          <div className="lg:col-span-3">
            ...
            <div className="card-app rounded-3xl px-5 sm:px-6 divide-y divide-primary/8">
              {whyItMatters.map((item) => (
                <div key={item.desc} className="flex items-center gap-4 py-4">
                  <div className="w-8 h-8 rounded-full chip-app flex items-center justify-center flex-shrink-0">
                    {item.icon}
                  </div>
          ...
          <div className="lg:col-span-2 card-app rounded-3xl p-6 sm:p-7 flex flex-col justify-center">
            <div className="w-11 h-11 rounded-full chip-app flex items-center justify-center mb-6">
