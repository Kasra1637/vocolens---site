          ...
          <AnimatedSection animation="fade-in-left" className="lg:pl-[11%]">
            ...
            <div className="grid grid-cols-2 gap-x-5 gap-y-2.5 mb-4 max-w-md">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-text-secondary font-medium">Pro transcription</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <span className="text-sm text-text-secondary font-medium">Neurodivergent-friendly</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <span className="text-sm text-text-secondary font-medium">30+ languages</span>
              </div>
            </div>
          </AnimatedSection>
